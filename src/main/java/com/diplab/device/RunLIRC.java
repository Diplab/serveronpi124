...
public class RunLIRC {
	...
	static enum Function {
		KEY_PLAY, KEY_F10, KEY_F11, KEY_F12, KEY_F13, KEY_F14, KEY_F15, KEY_F16, KEY_F17, KEY_F18, KEY_F19, KEY_F20, KEY_FN_F2, KEY_FN_F3, KEY_FN_F4, KEY_FN_F5, KEY_FN_F8, KEY_FN_F10, KEY_FN_F12, KEY_FN_ESC, KEY_AGAIN, KEY_POWER
	}
	...
	public static void blast() {
		try {
			...
			Process process = runtime.exec(new String[] { "/usr/bin/irsend",
					"SEND_ONCE", "/home/pi/lircd2.conf", "KEY_POWER" });
